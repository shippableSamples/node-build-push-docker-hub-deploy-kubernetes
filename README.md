...
### CI Console Log
![CI Console Log](https://github.com/shippableSamples/node-build-push-docker-hub-deploy-kubernetes/blob/master/public/resources/images/console-log.png)

### CI Integration View
![CI Integration View](https://github.com/shippableSamples/node-build-push-docker-hub-deploy-kubernetes/blob/master/public/resources/images/trigger-deploy-kubernetes.png)

### CD Pipeline
![CD Pipeline](https://github.com/shippableSamples/node-build-push-docker-hub-deploy-kubernetes/blob/master/public/resources/images/deployment-pipeline-to-kubernetes.png)
